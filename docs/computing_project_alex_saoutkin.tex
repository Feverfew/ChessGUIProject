...
\fancyhead[RE, LO]{Candidate Number: 2159}
...
\begin{table}[H]
	\resizebox{\textwidth}{!}{%
	\begin{tabular}{|p{0.04\textwidth}|p{0.1\textwidth}|p{0.15\textwidth}|p{0.25\textwidth}|p{0.23\textwidth}|p{0.13\textwidth}|p{0.1\textwidth}|}
		\hline
		...
		1 & 1c & Click piece & Check that other person's piece can't be moved & Not clickable & Figure & Yes \\ \hline
