...
\begin{table}[H]
	\resizebox{\textwidth}{!}{%
	\begin{tabular}{|p{0.04\textwidth}|p{0.15\textwidth}|p{0.1\textwidth}|p{0.25\textwidth}|p{0.23\textwidth}|p{0.13\textwidth}|p{0.1\textwidth}|}
		\hline
		\textbf{ID} & \textbf{Obj ID} & \textbf{Test Data} & \textbf{Description} & \textbf{Expected Result} & \textbf{Evidence} & \textbf{pass}\\ \hline
		1 & 1a & N/A & Check that program is usable. & A new game & Figure & Yes \\ \hline
		1 & 1b & Click piece & Check that other person's piece can't be moved & Not clickable & Figure & Yes \\ \hline
	\end{tabular}}
